...
Como já falado, desenvolvo minhas aplicações com **React e Laravel**, porém, meu principal foco é com **React**, utilizando principalmente **Typescript** e **Tailwind Css**. Já tive experiências com **Firebase** em um antigo projeto para a captação de visitantes, ainda continuo utilizando mas apenas em projetos pessoais, mas pretendo estudar outros bancos de dados como o **MongoDB** para futuros projetos.

Falando de algumas outras habilidades minhas, utilizo o **Photoshop** em alguns projetos quando necessito de imagens mais detalhadas, que falando neles, eu mesmo faço todos os designs deles pelo **Figma**, e utilizo o Adobe Ilustrator para criar as logos quando necessário.
